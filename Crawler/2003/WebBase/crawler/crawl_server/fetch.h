...
// FIXME: repository::MAX_URL_SIZE may be larger than MAX_ARCHIVE_HEADER_SIZE;
// archiver value needs to be synchronized to repository::MAX_URL_SIZE, or
// CRAWLER_MAX_URL_SIZE needs to be synchronized to archiver's actual limit.
...
//const int MAX_PAGE_SIZE        = repository::MAX_FILE_SIZE;
