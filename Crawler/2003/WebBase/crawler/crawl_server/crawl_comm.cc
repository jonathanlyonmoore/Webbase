...
int crawl_comm::get_request(std::string& request)
{   
...
int crawl_comm::send_response(const std::string& response)
{
...
int crawl_comm::send_report(const std::string& report)
{
...
int crawl_comm::send_new_site(const std::string& new_site)
{
