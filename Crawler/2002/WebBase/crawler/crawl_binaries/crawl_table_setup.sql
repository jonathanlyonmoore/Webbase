...
create table hosts (hid BIGINT PRIMARY KEY, hostname character varying(1024) unique not null, priority real not null, minpages integer, maxpages integer not null, mindepth integer,  maxdepth integer not null, imagesp boolean, pdfsp boolean, audiop boolean, minpause integer, rooturls text);
...
create table uncrawled (hid BIGINT PRIMARY KEY, id integer NOT NULL);
