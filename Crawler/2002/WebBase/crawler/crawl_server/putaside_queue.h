...
class putaside_queue {
   public:
      typedef map<string,int>::const_iterator  const_queue_iterator;
      typedef map<string,int>::iterator        queue_iterator;
      ...
      int get_size() const;
      int purge_url(string& url_list);

   private:
      map<string,int>  site_queue;
