...
class crawl_comm {
   public:
      ...
      int  get_request(string& request);
      int  send_response(const string& response);
      int  send_report(const string& report);
      int  send_new_site(const string& sites);
